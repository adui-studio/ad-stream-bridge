...
// node_modules/.pnpm/@vueuse+shared@14.2.1_vue@3.5.32_typescript@6.0.2_/node_modules/@vueuse/shared/dist/index.js
function computedEager(fn, options) {
  ...
  watchEffect(
    ...
    },
    {
      ...options,
      flush:
        (_options$flush = options === null || options === void 0 ? void 0 : options.flush) !==
          null && _options$flush !== void 0
          ? _options$flush
          : 'sync'
    }
  );
...
function provideLocal(key, value) {
  ...
  if (!localProvidedStateMap.has(owner))
    localProvidedStateMap.set(owner, /* @__PURE__ */ Object.create(null));
...
function reactify(fn, options) {
  const unrefFn =
    (options === null || options === void 0 ? void 0 : options.computedGetter) === false
      ? unref
      : toValue;
...
function refDefault(source, defaultValue) {
  return computed({
    get() {
      var _source$value;
      return (_source$value = source.value) !== null && _source$value !== void 0
        ? _source$value
        : defaultValue;
    },
    set(value) {
  ...
  for (const key in objectRef.value)
    result[key] = customRef(() => ({
      ...
      set(v) {
        var _toValue;
        if (
          (_toValue = toValue(options.replaceRef)) !== null && _toValue !== void 0 ? _toValue : true
        )
...
function useTimeout(interval = 1e3, options = {}) {
  ...
  const controls = useTimeoutFn(
    callback !== null && callback !== void 0 ? callback : noop,
    interval,
    options
  );
...
// node_modules/.pnpm/@vueuse+core@14.2.1_vue@3.5.32_typescript@6.0.2_/node_modules/@vueuse/core/dist/index.js
function computedAsync(evaluationCallback, initialState, optionsOrRef) {
  ...
  const {
    ...
    evaluating = void 0,
    shallow = true,
    onError = (_globalThis$reportErr = globalThis.reportError) !== null &&
    _globalThis$reportErr !== void 0
...
function unrefElement(elRef) {
  ...
  return (_$el = plain === null || plain === void 0 ? void 0 : plain.$el) !== null &&
    _$el !== void 0
    ? _$el
    : plain;
}
    ...
    () => {
      ...
      return [
        (_firstParamTargets$va =
          (_firstParamTargets$va2 = firstParamTargets.value) === null ||
          _firstParamTargets$va2 === void 0
            ? void 0
        ...
        (event) => {
          setTimeout(() => {
            ...
            if (
              ...
              !(el === null || el === void 0
                ? void 0
                : el.contains(window$1.document.activeElement))
            )
              handler(event);
          }, 0);
        },
...
function onLongPress(target, handler, options) {
  ...
  function onRelease(ev) {
    ...
    clear();
    if (
      !(options === null || options === void 0 ? void 0 : options.onMouseUp) ||
      !_posStart ||
      !_startTimestamp
    )
      return;
  ...
  function onMove(ev) {
    ...
    if (
      !posStart ||
      (options === null || options === void 0 ? void 0 : options.distanceThreshold) === false
    )
      return;
    if (
      options === null ||
    ...
    if (
      ...
      ((_options$distanceThre =
        options === null || options === void 0 ? void 0 : options.distanceThreshold) !== null &&
      _options$distanceThre !== void 0
        ? _options$distanceThre
        : DEFAULT_THRESHOLD)
    )
      clear();
...
function useAnimate(target, keyframes, options) {
  ...
  const pause = () => {
    try {
      var _animate$value;
      (_animate$value = animate.value) === null ||
        _animate$value === void 0 ||
        _animate$value.pause();
      syncPause();
    } catch (e) {
      onError(e);
    }
  ...
  const reverse = () => {
    ...
    try {
      var _animate$value2;
      (_animate$value2 = animate.value) === null ||
        _animate$value2 === void 0 ||
        _animate$value2.reverse();
      syncResume();
    } catch (e) {
      syncPause();
      onError(e);
  ...
  const finish = () => {
    try {
      var _animate$value3;
      (_animate$value3 = animate.value) === null ||
        _animate$value3 === void 0 ||
        _animate$value3.finish();
      syncPause();
    } catch (e) {
      onError(e);
    }
  ...
  const cancel = () => {
    try {
      var _animate$value4;
      (_animate$value4 = animate.value) === null ||
        _animate$value4 === void 0 ||
        _animate$value4.cancel();
      syncPause();
    } catch (e) {
      onError(e);
    }
  ...
  tasks.reduce((prev, curr) => {
    return prev
      .then((prevRes) => {
        ...
        if (
          ((_result$activeIndex$v = result[activeIndex.value]) === null ||
          _result$activeIndex$v === void 0
            ? void 0
...
function useBrowserLocation(options = {}) {
  ...
  const buildState = (trigger) => {
    ...
    const { state: state$1, length } =
      (window$1 === null || window$1 === void 0 ? void 0 : window$1.history) || {};
    const { origin } =
      (window$1 === null || window$1 === void 0 ? void 0 : window$1.location) || {};
  ...
  const update = () => {
    ...
    state.value =
      (_permissionStatus$val =
        (_permissionStatus$val2 = permissionStatus.value) === null ||
        _permissionStatus$val2 === void 0
          ? void 0
...
function useStorage(key, defaults$1, storage, options = {}) {
  ...
  const data = (shallow ? shallowRef : ref)(
    typeof defaults$1 === 'function' ? defaults$1() : defaults$1
  );
  ...
  if (window$1 && listenToStorageChanges)
    if (storage instanceof Storage)
      useEventListener(window$1, 'storage', onStorageEvent, { passive: true });
  ...
  function update(event) {
    ...
    try {
      ...
      if (
        event === void 0 ||
        (event === null || event === void 0 ? void 0 : event.newValue) !== serializedData
      )
...
function useCountdown(initialCountdown, options = {}) {
  ...
  const reset = (countdown) => {
    var _toValue;
    remaining.value =
      (_toValue = toValue(countdown)) !== null && _toValue !== void 0
        ? _toValue
...
function useCycleList(list, options) {
  ...
  function getInitialValue() {
    ...
    return (_toValue = toValue(
      (_options$initialValue =
        options === null || options === void 0 ? void 0 : options.initialValue) !== null &&
      ...
      useEventListener(
        ...
        createFilterWrapper(eventFilter, (event) => {
          ...
          acceleration.value = {
            ...
            y:
              ((_event$acceleration2 = event.acceleration) === null ||
              _event$acceleration2 === void 0
                ? void 0
                : _event$acceleration2.y) || null,
            z:
              ((_event$acceleration3 = event.acceleration) === null ||
              _event$acceleration3 === void 0
                ? void 0
          ...
          rotationRate.value = {
            ...
            beta:
              ((_event$rotationRate2 = event.rotationRate) === null ||
              _event$rotationRate2 === void 0
                ? void 0
                : _event$rotationRate2.beta) || null,
            gamma:
              ((_event$rotationRate3 = event.rotationRate) === null ||
              _event$rotationRate3 === void 0
                ? void 0
...
function useDisplayMedia(options = {}) {
  ...
  const enabled = shallowRef(
    (_options$enabled = options.enabled) !== null && _options$enabled !== void 0
      ? _options$enabled
      : false
  );
  ...
  const scrollSettings =
    typeof scrollConfig === 'object'
      ? {
          ...
          direction:
            (_scrollConfig$directi = scrollConfig.direction) !== null &&
            _scrollConfig$directi !== void 0
              ? _scrollConfig$directi
              : defaultScrollConfig.direction
        }
      : defaultScrollConfig;
  const getScrollAxisValues = (value) =>
  ...
  const handleAutoScroll = (container, targetRect, position$1) => {
    ...
    if (scrollSettings.direction === 'x' || scrollSettings.direction === 'both') {
      if (position$1.x < marginX && scrollLeft > 0) deltaX = -speedX;
        ...
        position$1.x + targetRect.width > clientWidth - marginX &&
...
function useDropZone(target, options = {}) {
  ...
  if (isClient) {
    ...
    const multiple =
      (_options$multiple = _options.multiple) !== null && _options$multiple !== void 0
        ? _options$multiple
        : true;
    const preventDefaultForUnhandled =
      (_options$preventDefau = _options.preventDefaultForUnhandled) !== null &&
      _options$preventDefau !== void 0
    ...
    const handleDragEvent = (event, eventType) => {
      ...
      isValid =
        (_ref = dataTransferItemList && checkValidity(dataTransferItemList)) !== null &&
        _ref !== void 0
          ? _ref
          : false;
        ...
        (e) => {
          ...
          data.value =
            (_serializer$read2 = serializer.read(e.data)) !== null && _serializer$read2 !== void 0
              ...
              : null;
          lastEventId.value =
            (_e$lastEventId = e.lastEventId) !== null && _e$lastEventId !== void 0
              ? _e$lastEventId
              : null;
        },
        { passive: true }
...
function useFavicon(newIcon = null, options = {}) {
  ...
  const applyIcon = (icon) => {
    ...
    if (!elements || elements.length === 0) {
      const link =
        document$1 === null || document$1 === void 0 ? void 0 : document$1.createElement('link');
      if (link) {
        link.rel = rel;
    ...
    return (payload, payloadType) => {
      if (!isFetching.value) {
        ...
        if (isRef(config.payload))
          watch([refetch, toRef2(config.payload)], ([refetch$1]) => refetch$1 && execute(), {
            deep: true
          });
        return {
          ...shell,
...
function useFileSystemAccess(options = {}) {
  ...
  const fileName = computed(() => {
    ...
    return (_file$value$name =
      (_file$value = file.value) === null || _file$value === void 0 ? void 0 : _file$value.name) !==
      null && _file$value$name !== void 0
      ? _file$value$name
      : '';
  });
  const fileMIME = computed(() => {
    ...
    return (_file$value$type =
      (_file$value2 = file.value) === null || _file$value2 === void 0
        ? void 0
        : _file$value2.type) !== null && _file$value$type !== void 0
      ? _file$value$type
      : '';
  });
  const fileSize = computed(() => {
    ...
    return (_file$value$size =
      (_file$value3 = file.value) === null || _file$value3 === void 0
        ? void 0
        : _file$value3.size) !== null && _file$value$size !== void 0
      ? _file$value$size
      : 0;
  });
  const fileLastModified = computed(() => {
    ...
    return (_file$value$lastModif =
      (_file$value4 = file.value) === null || _file$value4 === void 0
        ? void 0
        : _file$value4.lastModified) !== null && _file$value$lastModif !== void 0
  ...
  async function updateFile() {
    ...
    file.value = await ((_fileHandle$value = fileHandle.value) === null ||
    _fileHandle$value === void 0
      ? void 0
      ...
      return (_focused.value =
        (_targetElement$value$ =
          ...
          _targetElement$value$2 === void 0
            ? void 0
            : _targetElement$value$2.call(_targetElement$value, PSEUDO_CLASS_FOCUS_WITHIN)) !==
          null && _targetElement$value$ !== void 0
          ? _targetElement$value$
          : false);
    },
    listenerOptions
...
function useFullscreen(target, options = {}) {
  ...
  const isCurrentElementFullScreen = () => {
    if (fullscreenElementMethod)
      return (
        (document$1 === null || document$1 === void 0
          ? void 0
          : document$1[fullscreenElementMethod]) === targetRef.value
      );
    return false;
  };
  const isElementFullScreen = () => {
    if (fullscreenEnabled.value)
      if (document$1 && document$1[fullscreenEnabled.value] != null)
        return document$1[fullscreenEnabled.value];
      else {
        const target$1 = targetRef.value;
        if (
          (target$1 === null || target$1 === void 0 ? void 0 : target$1[fullscreenEnabled.value]) !=
          null
        )
  ...
  async function exit() {
    ...
    if (exitMethod.value)
      if (
        (document$1 === null || document$1 === void 0 ? void 0 : document$1[exitMethod.value]) !=
        null
      )
        ...
        const target$1 = targetRef.value;
        if (
          (target$1 === null || target$1 === void 0 ? void 0 : target$1[exitMethod.value]) != null
        )
...
function useGamepad(options = {}) {
  ...
  const updateGamepadState = () => {
    const _gamepads =
      (navigator$1 === null || navigator$1 === void 0 ? void 0 : navigator$1.getGamepads()) || [];
...
function useGeolocation(options = {}) {
  ...
  function resume() {
    if (isSupported.value)
      watcher = navigator$1.geolocation.watchPosition(
        updatePosition,
        (err) => (error.value = err),
        {
          enableHighAccuracy,
...
function useScroll(element, options = {}) {
  ...
  const setArrivedState = (target) => {
    ...
    const el =
      (target === null ||
      target === void 0 ||
      (_document2 = target.document) === null ||
      _document2 === void 0
        ? void 0
...
function useMagicKeys(options = {}) {
  ...
  function updateRefs(e, value) {
    ...
    const values = [
      (_e$code = e.code) === null || _e$code === void 0 ? void 0 : _e$code.toLowerCase(),
      key
    ].filter(Boolean);
    if (!key) return;
    if (key)
...
function useMouse(options = {}) {
  ...
  if (target) {
    ...
    if (scroll && type === 'page')
      useEventListener(window$1, 'scroll', scrollHandlerWrapper, listenerOptions);
  }
  return {
    x,
    y,
...
function useNavigatorLanguage(options = {}) {
  ...
  const language = shallowRef(
    navigator$1 === null || navigator$1 === void 0 ? void 0 : navigator$1.language
  );
  useEventListener(
    window$1,
    'languagechange',
  ...
  if (isSupported.value) {
    ...
    useEventListener(
      ...
      () => {
        ...
        const currentElement =
          (_pointerLockElement = document$1.pointerLockElement) !== null &&
          _pointerLockElement !== void 0
            ? _pointerLockElement
            : element.value;
    ...
    useEventListener(
      ...
      () => {
        ...
        const currentElement =
          (_pointerLockElement2 = document$1.pointerLockElement) !== null &&
          _pointerLockElement2 !== void 0
  ...
  const eventIsAllowed = (e) => {
    ...
    return (_ref =
      (_options$pointerTypes =
        (_options$pointerTypes2 = options.pointerTypes) === null ||
        _options$pointerTypes2 === void 0
          ? void 0
          : _options$pointerTypes2.includes(e.pointerType)) !== null &&
      _options$pointerTypes !== void 0
        ? _options$pointerTypes
  ...
  const stops = [
    ...
    useEventListener(
      ...
      (e) => {
        if (!eventIsAllowed(e)) return;
        if (isSwiping.value)
          onSwipeEnd === null || onSwipeEnd === void 0 || onSwipeEnd(e, direction.value);
...
function useScrollLock(element, initialState = false) {
  ...
  const unlock = () => {
    ...
    if (!el || !isLocked.value) return;
    if (isIOS)
      stopTouchMoveListener === null || stopTouchMoveListener === void 0 || stopTouchMoveListener();
...
function useSpeechRecognition(options = {}) {
  ...
  const SpeechRecognition =
    window$1 && (window$1.SpeechRecognition || window$1.webkitSpeechRecognition);
...
function useStepper(steps, initialStep) {
  ...
  const index = ref(
    stepNames.value.indexOf(
      initialStep !== null && initialStep !== void 0 ? initialStep : stepNames.value[0]
    )
  );
...
function useStorageAsync(key, initialValue, storage, options = {}) {
  ...
  if (window$1 && listenToStorageChanges)
    useEventListener(window$1, 'storage', (e) => Promise.resolve().then(() => read(e)), {
      passive: true
    });
  if (storage)
    watchWithFilter(
...
function useTextDirection(options = {}) {
  ...
  if (observe && document$1)
    useMutationObserver(document$1.querySelector(selector), () => (dir.value = getValue$1()), {
      attributes: true
    });
  return computed({
    get() {
...
function useTextSelection(options = {}) {
  ...
  const selection = shallowRef(
    (_window$getSelection =
      window$1 === null || window$1 === void 0 ? void 0 : window$1.getSelection()) !== null &&
  ...
  if (window$1)
    useEventListener(window$1.document, 'selectionchange', onSelectionChange, { passive: true });
  return {
    text,
    rects,
    ranges,
...
function tryRequestAnimationFrame(window$1 = defaultWindow, fn) {
  if (window$1 && typeof window$1.requestAnimationFrame === 'function')
...
function useTextareaAutosize(options = {}) {
  ...
  const styleProp =
    (_options$styleProp = options === null || options === void 0 ? void 0 : options.styleProp) !==
      null && _options$styleProp !== void 0
      ? _options$styleProp
      : 'height';
  ...
  function triggerResize() {
    ...
    const _styleTarget = toValue(
      options === null || options === void 0 ? void 0 : options.styleTarget
    );
...
function getTimeAgoIntlResult(from, options = {}, now2 = Date.now()) {
  ...
  const absDiff = Math.abs(diff);
  const units =
    (_options$units = options.units) !== null && _options$units !== void 0 ? _options$units : UNITS;
...
function useTitle(newTitle = null, options = {}) {
  ...
  const originalTitle =
    (_document$title = document$1 === null || document$1 === void 0 ? void 0 : document$1.title) !==
      null && _document$title !== void 0
      ? _document$title
      : '';
  const title = toRef2(
    (_ref =
...
function transition(source, from, to, options = {}) {
  ...
  const duration =
    (_toValue2 = toValue(options.duration)) !== null && _toValue2 !== void 0 ? _toValue2 : 1e3;
  ...
  return new Promise((resolve) => {
    ...
    const tick = () => {
      ...
      if (now2 < endAt)
        window$1 === null || window$1 === void 0 || window$1.requestAnimationFrame(tick);
      else {
        source.value = toVal;
        resolve();
      }
...
function useUrlSearchParams(mode = 'history', options = {}) {
  ...
  function constructQuery(params) {
    ...
    if (mode === 'history')
      return `${stringified ? `?${stringified}` : ''}${window$1.location.hash || ''}`;
    if (mode === 'hash-params')
      return `${window$1.location.search || ''}${stringified ? `#${stringified}` : ''}`;
    const hash = window$1.location.hash || '#';
    const index = hash.indexOf('?');
    if (index > 0)
...
function useWakeLock(options = {}) {
  const { navigator: navigator$1 = defaultNavigator, document: document$1 = defaultDocument } =
    options;
  ...
  if (isSupported.value) {
    ...
    whenever(
      () =>
        ...
        (document$1 === null || document$1 === void 0 ? void 0 : document$1.visibilityState) ===
          'visible' &&
        requestedType.value,
      (type) => {
...
function useWebNotification(options = {}) {
  const { window: window$1 = defaultWindow, requestPermissions: _requestForPermissions = true } =
    options;
...
//# sourceMappingURL=chunk-2Z5ASARH.js.map
